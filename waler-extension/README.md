...
- **Synchronisation automatique** avec le backend FlowTrack
...
L'extension se connecte automatiquement à l'API FlowTrack sur `http://localhost:5000`.
...
Cette extension fait partie du projet FlowTrack. Pour contribuer, voir le README principal.
