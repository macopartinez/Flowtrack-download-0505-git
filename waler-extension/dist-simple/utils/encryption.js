...
KeyManager.STORAGE_KEY = 'encryption_key';
KeyManager.SALT_KEY = 'encryption_salt';
...
export class SecureStorage {
     ...
     */
    static async storeDM(messageId, message) {
