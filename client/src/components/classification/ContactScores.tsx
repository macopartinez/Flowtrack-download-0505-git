      ...
      <Card>
        <CardContent className="p-12">
          <div className="text-center space-y-2">
            ...
            <h3 className="text-lg font-semibold">Aucun score</h3>
            <p className="text-muted-foreground">
              Les scores des contacts apparaîtront ici après analyse
            </p>
          </div>
        </CardContent>
      </Card>
          ...
          <Card key={score.contact_username} className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="text-xs text-muted-foreground pt-2 border-t">
                Mis à jour {new Date(score.last_calculated_at).toLocaleDateString('fr-FR')}
              </div>
            </CardContent>
          </Card>
        ))}
