...
import { X, Settings, Monitor, Database, Trash2, LogOut, Bell, Lock, User } from "lucide-react";
...
export function ProSettingsModal({ isOpen, onClose, onClearData, onLogout }: ProSettingsModalProps) {
  const [activeTab, setActiveTab] = useState<'display' | 'data' | 'notifications' | 'privacy' | 'account'>('display');
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/5 rounded-xl p-4">
                      <label className="text-sm text-gray-400 block mb-1">Pro Dashboard</label>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-white/5 rounded-xl p-4">
                      ...
                      <p className="text-sm text-gray-400 mb-4">Delete all clients, people, and settings stored locally. This cannot be undone.</p>
                      <button
                        onClick={() => {
                          if (confirm('Are you sure you want to clear all local data? This cannot be undone.')) {
                            localStorage.removeItem('pro-clients');
