            ...
            {step === "send" ? (
              <>
                <div className="text-center mb-8">
                  ...
                  <h1 className="text-3xl font-bold mb-2">Vérifiez votre compte</h1>
                  <p className="text-gray-400">
                    Envoyez ce code à <span className="text-[#02c950]">@waler_official</span> depuis votre compte{" "}
                ...
                <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 mb-6">
                  <div className="flex items-start gap-2 text-sm text-green-200">
                    ...
                    <p>
                      <strong>Important:</strong> Vous devez envoyer ce message depuis{" "}
                      <strong>@{username}</strong>, sinon la vérification échouera pour des raisons de sécurité.
                    </p>
                  </div>
                </div>
              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <h1 className="text-3xl font-bold mb-2">Entrez le code reçu</h1>
                  <p className="text-gray-400">
                    Waler vous a répondu avec un code à 6 chiffres
                  </p>
                </div>
