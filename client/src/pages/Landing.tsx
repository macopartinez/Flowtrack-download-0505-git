            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {[
                ...
                },
                {
                  ...
                  a: "\"Our employee\" creates a snapshot of your follower list and compares it periodically with new data. This allows us to detect exactly who unfollowed you, who followed you, and which accounts were deactivated or deleted."
                },
                {
