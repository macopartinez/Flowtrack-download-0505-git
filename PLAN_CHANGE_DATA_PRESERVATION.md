...
**IMPORTANT:** Dans FlowTrack, **AUCUNE DONNÉE N'EST JAMAIS SUPPRIMÉE** lors d'un changement de plan, qu'il s'agisse d'un upgrade, downgrade ou annulation.
...
👤 Utilisateur de test: pako_mrtz (paco242019@gmail.com)
   Plan actuel: premium
...
FlowTrack garantit la **préservation totale des données** lors de tout changement de plan. Cette garantie est :
