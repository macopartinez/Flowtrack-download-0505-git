...
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres.sjcekxuhbeowudppuzfe:GblvDCpse4TWpaRO@aws-0-us-west-2.pooler.supabase.com:6543/postgres';
