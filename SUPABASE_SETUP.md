...
Dans le dossier `FlowTrack`, créez un fichier nommé `.env` (sans extension):

**Windows (PowerShell):**
```powershell
cd c:\Users\Lenovo\Downloads\FlowTrack\FlowTrack
...
Votre application FlowTrack utilise maintenant Supabase PostgreSQL!
