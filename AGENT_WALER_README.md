...
L'**Agent Waler** est l'agrégateur et synchroniseur principal du système FlowTrack/Waler. Il collecte les données de tous les agents (A, B, C...) et les consolide dans la base de données finale.
