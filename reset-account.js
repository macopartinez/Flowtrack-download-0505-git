...
async function resetAccount() {
  ...
  try {
    ...
    await client.query(`DELETE FROM app_users WHERE email = $1`, ['paco242019@gmail.com']);
    console.log('🗑️  Deleted existing account');
    
    // Hash password
    const passwordHash = await bcrypt.hash('DevPako2026!', 12);
    ...
    `, ['pako_mrtz', 'paco242019@gmail.com', passwordHash, 'instagram', 'pro', 'active', true]);
    
    console.log('✅ Fresh Pro account created!\n');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('📧 Email: paco242019@gmail.com');
